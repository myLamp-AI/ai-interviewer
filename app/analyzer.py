...
def summary_results(results,llm):
    prompt = PromptTemplate(
        ...
        template="""
        As an Expert HR, Judge the question answer of interview question strictly on multiple metrics, providing scores and thorough reasoning for each score. 

        Questions and Answers:
        {qa_pairs}

        For each question answer pair, provide the following:
        1. Summarize the Overall performance of the Candidate
        2. Relevance Score (0-10): How relevant is this line to the question asked?
        3. Depth Score (0-10): How in-depth or detailed is this line?
        4. Professionalism Score (0-10): How professional is the language and content?
        5. Technical Accuracy Score (0-10): How technically accurate is the information provided? (If applicable)
        ...
        {{
            "analysis": [
                {{
                    "summmary":"Detailed Summary of Performance"
                    "relevance": {{"score": 0, "reasoning": ""}},
                    "depth": {{"score": 0, "reasoning": ""}},
                    "professionalism": {{"score": 0, "reasoning": ""}},
                    "technical_accuracy": {{"score": 0, "reasoning": ""}}
